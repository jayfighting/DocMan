...
//
// namespace LD.DocMan.API.Application.Behaviors
// {
//     public class TransactionBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
//     {
//         private readonly DocManDbContext  _dbContext;
//         private readonly ILogger<TransactionBehaviour<TRequest, TResponse>> _logger;
//         // private readonly IOrderingIntegrationEventService _orderingIntegrationEventService;
//
//         public TransactionBehaviour(DocManDbContext dbContext,
//             // IOrderingIntegrationEventService orderingIntegrationEventService,
//             ILogger<TransactionBehaviour<TRequest, TResponse>> logger)
//         {
//             _dbContext = dbContext ?? throw new ArgumentException(nameof(DocManDbContext));
